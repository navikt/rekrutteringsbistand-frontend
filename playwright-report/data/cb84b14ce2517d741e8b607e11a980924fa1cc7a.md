...
- Name: Legg til kandidat knapp  >> Finner ikke kandidat
- Location: /home/runner/work/rekrutteringsbistand-frontend/rekrutteringsbistand-frontend/tests/stilling/vis-stilling/legg-til-kandidat.spec.ts:53:7
...
Locator: getByText('Finner ikke person knyttet')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Finner ikke person knyttet')

    at /home/runner/work/rekrutteringsbistand-frontend/rekrutteringsbistand-frontend/tests/stilling/vis-stilling/legg-til-kandidat.spec.ts:62:64
```
...
- main:
  ...
  - tablist:
    ...
    - dialog "Legg til kandidater til International Paradigm Developer":
      ...
      - textbox "Fødselsnummer på kandidat": "22034609946"
      - img "Feil"
      - paragraph: Det oppstod en feil ved søk på fødselsnummer
