import{d5 as p,w as m,d4 as c,d6 as g,aH as e,Z as l}from"./iframe-Dq6jy88q.js";import"./preload-helper-PPVm8Dsz.js";const v={tags:["autodocs"],component:p},n={args:{message:"Dette er en enkel feilmelding"}},s={args:{error:new m({message:"Kunne ikke hente kandidater",feilkode:"REKBIS-12345",details:"API-kall til /api/kandidater feilet med 500 Internal Server Error"})}},a={args:{error:new m({message:"En feil oppstod under lagring",feilkode:"REKBIS-67890"})}},t={args:{zodError:(()=>{const d=c({navn:e().min(2,"Navn må være minst 2 tegn"),epost:e().email("Ugyldig e-postadresse"),alder:g().min(18,"Må være minst 18 år")});try{d.parse({navn:"A",epost:"ikke-en-epost",alder:15})}catch(r){if(r instanceof l)return r}})()}},o={args:{zodError:(()=>{const d=c({fornavn:e().min(1,"Fornavn er påkrevd"),etternavn:e().min(1,"Etternavn er påkrevd"),telefon:e().regex(/^\d{8}$/,"Telefonnummer må være 8 siffer"),postnummer:e().length(4,"Postnummer må være 4 siffer"),dato:e().min(1,"Dato er påkrevd")});try{d.parse({fornavn:"",etternavn:"",telefon:"123",postnummer:"12",dato:""})}catch(r){if(r instanceof l)return r}})()}},i={args:{error:new Error("Dette er en standard JavaScript Error"),message:"En uventet feil oppstod"}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
