import{j as e}from"./iframe-DSdiPFC4.js";import{E as s}from"./ErrorBoundary-CeDPWePC.js";import"./preload-helper-PPVm8Dsz.js";const t=({message:a})=>{throw new Error(a)},m={tags:["autodocs"],component:s},r={render:()=>e.jsx(s,{children:e.jsxs("div",{style:{padding:"2rem"},children:[e.jsx("h2",{children:"Alt fungerer!"}),e.jsx("p",{children:"Denne komponenten kaster ingen feil."})]})})},n={render:()=>e.jsx(s,{children:e.jsx(t,{message:"Dette er en test-feil!"})})},o={render:()=>e.jsx(s,{children:e.jsx(t,{message:"Dette er en veldig lang feilmelding som beskriver hva som gikk galt i detalj. Den inneholder mye informasjon om konteksten rundt feilen, hva som ble forsøkt, og hvorfor det feilet. Dette kan være nyttig for debugging, men kan også være overveldende for brukeren."})})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
