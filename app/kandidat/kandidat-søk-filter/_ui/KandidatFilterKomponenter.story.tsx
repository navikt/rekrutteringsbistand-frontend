...
const meta = {
  tags: ['autodocs'],
  render: () => (
    <div className='pointer-events-none grid max-w-[880px] grid-cols-1 gap-8 opacity-60 md:grid-cols-2'>
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Arbeidsønsker</h4>
        <Arbeidsønsker />
      </section>
      <section className='space-y-2'>
      ...
      <section className='space-y-2 md:col-span-2'>
        <h4 className='text-sm font-semibold'>Innsatsgrupper</h4>
        <Innsatsgrupper />
      </section>
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Utdanningsnivå</h4>
        <Utdanningsnivå />
      </section>
      <section className='space-y-2'>
      ...
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Arbeidserfaring</h4>
        <Arbeidserfaring />
      </section>
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Prioriterte målgrupper</h4>
        <PrioriterteMålgrupper />
      </section>
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Fritekstsøk</h4>
        <FritekstSøk />
      </section>
      <section className='space-y-2'>
        <h4 className='text-sm font-semibold'>Kandidat sted søk</h4>
        <KandidatStedSøk />
      </section>
    </div>
  ),
