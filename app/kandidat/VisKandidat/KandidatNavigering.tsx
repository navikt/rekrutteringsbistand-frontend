...
//   kandidatnr,
// }) => {
//   const { kandidatNavigering, setKandidatNavigering } = useKandidatNavigeringContext();
//   const router = useRouter();

//   React.useEffect(() => {
//     if (kandidatNavigering && kandidatNavigering.length > 0) {
//       const kandidatPlassering = kandidatNavigering.indexOf(kandidatnr);
