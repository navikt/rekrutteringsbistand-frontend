...
// Endepunkt: /api/stillings-sok/esSearch
// Forventer en body (ElasticSearch DSL) og proxier videre kun for treff (uten aggregeringer)
export async function POST(req: NextRequest) {
  ...
  // Sørg for at upstream-path ikke får /esSearch suffix
