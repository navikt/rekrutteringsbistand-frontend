...
import FullførArbeidsplassenStillingsoppdrag from '@/app/stilling/[stillingsId]/_ui/stilling-handlinger/arbeidsplassen/FullførArbeidsplassenStillingsoppdrag';
  ...
  return (
    <div className='flex gap-1'>
      ...
      <div className='hidden @min-[700px]/header:block'>
        <FullførArbeidsplassenStillingsoppdrag />
      </div>
