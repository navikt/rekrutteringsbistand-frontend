...
} from '@/app/api/rekrutteringstreff/[...slug]/treffgjennomforing/mutations';
import type {
...
const Intervjufordeling: FC<Props> = ({
  ...
  const fordelingerFraServer = useMemo(
    ...
    [arbeidsgivereMedId, treffgjennomforing.intervjufordelinger],
  );
    ...
    <VStack gap='space-24'>
      ...
      >
        <VStack gap='space-16'>
          ...
          {treffgjennomforing.interesser.length === 0 && (
