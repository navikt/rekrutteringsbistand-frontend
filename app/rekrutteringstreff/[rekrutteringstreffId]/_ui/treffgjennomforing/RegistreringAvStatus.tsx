...
import { AndregangsintervjuDato } from '@/app/rekrutteringstreff/[rekrutteringstreffId]/_ui/treffgjennomforing/AndregangsintervjuDato';
...
import { VurderingsNotater } from '@/app/rekrutteringstreff/[rekrutteringstreffId]/_ui/treffgjennomforing/VurderingsNotater';
...
import { useVurderingAutolagring } from '@/app/rekrutteringstreff/[rekrutteringstreffId]/_ui/treffgjennomforing/useVurderingAutolagring';
  ...
  const kort = useMemo(
    () =>
      lagRegistreringAvStatus({
        treffgjennomforing: effektivTreffgjennomforing,
        arbeidsgivere,
        jobbsøkere,
        formidlinger: formidlingerData,
      }),
    [arbeidsgivere, effektivTreffgjennomforing, formidlingerData, jobbsøkere],
  );
  const visNavn = useMemo(
    () => lagNavnvisning(effektivTreffgjennomforing),
    [effektivTreffgjennomforing],
  );
