...
import { harRegistrertNoe } from '@/app/api/rekrutteringstreff/[...slug]/treffgjennomforing/useTreffgjennomforing';
import type {
...
export const lagRegistreringAvStatus = ({
  ...
  return arbeidsgivere
    ...
    .map((arbeidsgiver) => {
      ...
      const intervjufordeling = treffgjennomforing.intervjufordelinger.find(
