import type { RegistreringForArbeidsgiver } from '@/app/rekrutteringstreff/[rekrutteringstreffId]/_ui/treffgjennomforing/registreringAvStatusHjelpere';
...
export interface Treffgjennomforingoppsummering {
  antallMøtt: number;
...
export const lagOppsummering = ({
  ...
  antallPåmeldte,
  antallIntervjuer,
}: LagOppsummeringInput): Treffgjennomforingoppsummering => {
