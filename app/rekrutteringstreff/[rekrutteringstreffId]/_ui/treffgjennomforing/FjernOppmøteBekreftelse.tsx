...
import type { Treffgjennomforingsregistreringer } from '@/app/api/rekrutteringstreff/[...slug]/treffgjennomforing/treffgjennomforingHjelpere';
...
export const FjernOppmøteBekreftelse: FC<Props> = ({
  ...
  >
    <Modal.Body>
      <BodyLong spacing>
        Dette sletter registreringene for {omtale} i treffgjennomforingen:
      </BodyLong>
      <List>
