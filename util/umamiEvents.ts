...
const Stilling = lagEventPrefix(UmamiDomene.Stilling, {
  ...
  kopier_delingslenke_direktemeldt: 'Kopier delingslenke for direktemeldt stilling',
  kopier_delingslenke_arbeidsplassen: 'Kopier delingslenke for arbeidsplassen-stilling',
});
